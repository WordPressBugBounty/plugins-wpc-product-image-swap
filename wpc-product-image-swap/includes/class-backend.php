...
if ( ! class_exists( 'Wpcis_Backend' ) && class_exists( 'WC_Product' ) ) {
    class Wpcis_Backend {
            ...
            <div class="wpclever_settings_page wrap">
                <div class="wpclever_settings_page_header">
                    ...
                    <div class="wpclever_settings_page_header_text">
                        <div class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Product Image Swap', 'wpc-product-image-swap' ) . ' ' . esc_html( WPCIS_VERSION ) . ' ' . ( defined( 'WPCIS_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-product-image-swap' ) . '</span>' : '' ); ?></div>
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
                                ...
                                <br/>
                                <a href="<?php echo esc_url( WPCIS_REVIEWS ); ?>"
                                   target="_blank"><?php esc_html_e( 'Reviews', 'wpc-product-image-swap' ); ?></a> |
                                <a href="<?php echo esc_url( WPCIS_CHANGELOG ); ?>"
                                   target="_blank"><?php esc_html_e( 'Changelog', 'wpc-product-image-swap' ); ?></a> |
                                <a href="<?php echo esc_url( WPCIS_DISCUSSION ); ?>"
                                   target="_blank"><?php esc_html_e( 'Discussion', 'wpc-product-image-swap' ); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
                <h2></h2>
                <?php // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- admin page display only
                ...
                <div class="wpclever_settings_page_nav">
                    <h2 class="nav-tab-wrapper">
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcis&tab=settings' ) ); ?>"
                           class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
                            <?php esc_html_e( 'Settings', 'wpc-product-image-swap' ); ?>
                        </a>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-wpcis&tab=premium' ) ); ?>"
                                ...
                                <tr class="submit">
                                    <th colspan="2">
                                        <div class="wpclever_submit">
                                            <?php
                                            settings_fields( 'wpcis_settings' );
                                        ...
                                        <a style="display: none;" class="wpclever_export" data-key="wpcis_settings"
                                           data-name="settings"
                                           href="#"><?php esc_html_e( 'import / export', 'wpc-product-image-swap' ); ?></a>
                                    </th>
                                </tr>
                            </table>
                        </form>
                    <?php } elseif ( $active_tab == 'premium' ) { ?>
                        <div class="wpclever_settings_page_content_text">
                            <p>Get the Premium Version just $29!
                                <a href="https://wpclever.net/downloads/wpc-product-image-swap/?utm_source=pro&utm_medium=wpcis&utm_campaign=wporg"
                                   target="_blank">https://wpclever.net/downloads/wpc-product-image-swap/</a>
                            </p>
        ...
        function style_settings( $product_id = 0 ) {
                            ...
                            <div class="wpcis-preview-inner">
                                <ul class="products">
                                    <li class="product wpcis wpcis-swap">
                                        <img src="<?php echo esc_url( WPCIS_URI . 'assets/images/preview_01.jpg' ); ?>"
                                             width="300" height="300" alt=""/>
                                        <img src="<?php echo esc_url( WPCIS_URI . 'assets/images/preview_02.jpg' ); ?>"
                                             width="300" height="300" class="wpcis-swap-image animate__animated"
                                             alt=""/>
                                        <span class="wpcis-swap-data"
                                              data-in="<?php echo esc_attr( $swap['effect_in'] ); ?>"
                                              data-out="<?php echo esc_attr( $swap['effect_out'] ); ?>"></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <script type="text/template" id="tmpl-wpcis-slider">
                            <div class="wpcis-slider-slides">
                                <ul class="slides">
                                    <li>
                                        <img src="<?php echo esc_url( WPCIS_URI . 'assets/images/preview_01.jpg' ); ?>"
                                             width="300" height="300" class="wpcis-slider-image" alt=""/>
                                    </li>
                                    <li>
                                        <img src="<?php echo esc_url( WPCIS_URI . 'assets/images/preview_02.jpg' ); ?>"
                                             width="300" height="300" class="wpcis-slider-image" alt=""/>
                                    ...
                                    <li>
                                        <img src="<?php echo esc_url( WPCIS_URI . 'assets/images/preview_03.jpg' ); ?>"
                                             width="300" height="300" class="wpcis-slider-image" alt=""/>
                                    </li>
                                </ul>
                            </div>
            ...
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
                <th><?php esc_html_e( 'Touch', 'wpc-product-image-swap' ); ?></th>
                <td>
                    <label> <select name="<?php echo esc_attr( $name_slider ); ?>[touch]">
                            <option value="true" <?php selected( $slider['touch'], 'true' ); ?>><?php esc_html_e( 'yes', 'wpc-product-image-swap' ); ?></option>
                            <option value="false" <?php selected( $slider['touch'], 'false' ); ?>><?php esc_html_e( 'no', 'wpc-product-image-swap' ); ?></option>
                        </select> </label>
                    <span class="description"><?php esc_html_e( 'Allow touch swipe navigation of the slider on touch-enabled devices.', 'wpc-product-image-swap' ); ?></span>
                </td>
            </tr>
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
            ...
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
                ...
                <td>
                    <label>
                        <input type="number" class="text small-text" step="1" min="0"
                               name="<?php echo esc_attr( $name_slider ); ?>[slideshowSpeed]"
                               value="<?php echo esc_attr( $slider['slideshowSpeed'] ); ?>"/>
                    </label>
            ...
            <tr class="wpcis_hide_if_type wpcis_tr_show_if_type_slider">
                ...
                <td>
                    <label>
                        <input type="number" class="text small-text" min="2" max="100" step="1"
                               name="<?php echo esc_attr( $name_slider ); ?>[maxItems]"
                               value="<?php echo esc_attr( absint( $slider['maxItems'] ) ); ?>"/>
                    </label>
